...
export function InvoiceDocument({ data }: InvoiceDocumentProps) {
  ...
  return (
    <div className="invoice-document bg-white min-h-[11in] w-[8.5in] mx-auto p-6 shadow-sm border border-secondary text-[#1A1A1A] flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center mb-6">
        ...
        <div className="text-[10px] opacity-75 max-w-xl space-y-0.5">
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-left">
          <h2 className="text-2xl font-headline italic text-secondary opacity-50 uppercase tracking-tighter mb-1">INVOICE</h2>
        ...
        <div className="text-right max-w-xs">
          <h3 className="text-[9px] font-bold uppercase tracking-widest opacity-60 mb-0.5">Billed To</h3>
          <div className="text-base font-semibold">{data.client.name || '---'}</div>
          <div className="text-xs opacity-75">{data.client.email}</div>
          <div className="text-xs opacity-75 whitespace-pre-line">{data.client.address}</div>
        </div>
      </div>
      ...
      <div className="mb-4">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-xs divide-y divide-secondary/30">
      ...
      {/* Totals Block - Now follows directly after table */}
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t border-secondary/30 mt-auto">
        <div className="text-[9px]">
          <h3 className="font-bold uppercase tracking-widest opacity-60 mb-0.5">Notes & Terms</h3>
        ...
        <div className="text-right text-[8px] uppercase tracking-widest opacity-50 flex flex-col justify-end">
