        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-700">
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl opacity-60">
            <div className="p-6">
              ...
              <p className="text-sm">
                Carefully crafted typography and spacing for high
                readability.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                Download professional-grade PDFs directly from your
                browser.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                A distraction-free experience focused on getting you
                paid.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 py-8 opacity-40 text-xs tracking-widest uppercase">
            Designed by{" "}
            <a
              href="https://www.simonpetersgh.com"
              target="_blank"
